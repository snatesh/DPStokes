...
#The class FCMJoint in this source code joins both the GPU and CPU python interfaces into a common one. 
...
try:
  ...
  print('Could not load UAMMD GPU Python interface: This will be included in a future public release')
...
class FCMJoint:
    ...
    def __init__(self, device = 'cpu'):
        self.device = device
        if self.device == 'gpu':
          print('gpu interface is not available. proceeding with cpu')
          self.device = 'cpu'
